...
export const services: Service[] = [
  ...
  },
  {
    ...
    heroImage: '/images/services/bluemenstrausse/brautsrauss_lila.webp',
    images: [
      { src: '/images/services/bluemenstrausse/brautsrauss_lila.webp', alt: 'Brautstrauß in Lila', corner: 'bottom-left' },
      { src: '/images/services/bluemenstrausse/strauss_weiss.webp', alt: 'Weißer Blumenstrauß', corner: 'bottom-left' },
    ],
    sizes: [
